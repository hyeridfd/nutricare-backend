...
# [중요] preference_persistence_patch는 agents/preference_update_agent.py의
# save_weights/load_weights/save_pool_scores/load_pool_scores를 Supabase
# 호출로 교체함. candidate_agent.py가 load_pool_scores를 직접 import해
# 쓰므로, 이 패치는 다른 어떤 agents 모듈보다도 먼저 적용되어야 함 —
# 그래서 라우터 import보다 앞선 여기서 가장 먼저 호출함.
